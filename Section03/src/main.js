...
class Game {
    ...
    players = [];
    timer = 60;
    timerInterval = null; // 타이머 interval
    sounds = {};
    doll;
    ...
    createGameCover() {
        ...
        cover.addEventListener('click', () => {
            if (!this.gameStarted) {
                this.startGame();
                cover.style.display = 'none'; // 게임 시작 시 cover 숨김
            }
        });
    ...
    startTimer() {
        ...
        if (this.timerInterval) clearInterval(this.timerInterval); // 이전 interval 제거
    ...
    endGame() {
        ...
        resultText.textContent = `생존자: ${survivors}명`;
